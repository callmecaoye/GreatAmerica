...
//    public GlideCacheTask(Context mBaseActivity) {
//        this(mBaseActivity, null, null);
//    }
//
//    public GlideCacheTask(Context mBaseActivity, GlideCacheListener listener) {
//        this(mBaseActivity, null, listener);
//    }
//
//    public GlideCacheTask(Context mBaseActivity, File cacheFile) {
//        this(mBaseActivity, cacheFile, null);
//    }
...
//        copyFile(path, mBaseActivity.getExternalCacheDir()+ Md5.getFileName(imgUrl));
