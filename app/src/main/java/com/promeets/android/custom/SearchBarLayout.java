...
/**
 * Created by sosasang on 6/19/17.
 */
...
public class SearchBarLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mPadding10 = ScreenUtil.convertDpToPx(10, getContext());
        //EditText
        if(!isInEditMode()){
        ...
        mEditText.setBackgroundResource(R.drawable.search_bar);
        imgX=getResources().getDrawable(R.drawable.ic_close_gray);
        ...
        final Drawable search=getContext().getResources().getDrawable(R.drawable.ic_search);
        ...
        cancelTextView.setPadding(mPadding10*2, 0, 0, 0);
        //CancelTextView
        cancelTextView.setText("Cancel");
        cancelTextView.setTextColor(getResources().getColor(R.color.pm_gray));
        //float size=mTextView.getTextSize()/(getContext().getResources().getDisplayMetrics().density);
        cancelTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP,16);
        if(!isInEditMode()){
                    ...
                    case MotionEvent.ACTION_DOWN:
                        if (event.getX() > mEditText.getWidth() - mEditText.getPaddingRight() - imgX.getIntrinsicWidth()) {
                            ...
                            if(ViewHelper.getTranslationX(cancelTextView)!=0){
                                ...
                                requestFocusFromTouch();
                                if(hasAnimtion){
                                    com.nineoldandroids.animation.ObjectAnimator.ofFloat(mTextView,"translationX",ViewHelper.getTranslationX(mTextView),0).start();
                                }else{
    ...
    private class CancelTextView extends android.support.v7.widget.AppCompatTextView{
            ...
            public boolean onTouch(final View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_CANCEL:
                        android.animation.ObjectAnimator.ofFloat(v, "alpha",0.3f,1.0f).start();
                        break;
                    case MotionEvent.ACTION_DOWN:
